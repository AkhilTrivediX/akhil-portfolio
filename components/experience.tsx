    ...
    return(
        <div className="w-[100vw]  text-foreground text-opacity-60 relative">
                {experiencesInfo.map((experience, experiencei)=>(
                    <div className={"w-full h-screen flex flex-col lg:flex-row items-start justify-start lg:justify-start lg:items-center sticky top-0 bg-background"+(experiencei!=0?" mt-[20%]":"")} key={experiencei}>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                {experience.previews.map((preview, previewi)=>(
                                    <div className="flex p-[1px] bg-foreground bg-opacity-60 w-[max-content] cutBanner cursor-pointer" style={currentPreviews[experiencei]==previewi?{backgroundColor:experience.color, color:experience.color}:{}} onClick={()=>{
                    ...
                    <div id={'previewE'+experiencei+'Parent'} className="w-full h-full lg:w-[50%] absolute bottom-0 right-0 overflow-hidden bg-background bg-opacity-60 opacity-0 lg:opacity-100 pointer-events-none lg:pointer-events-auto">
