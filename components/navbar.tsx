...
{
    return(
        <div id='navbar' key='navbar' className="hidden w-[max-content] px-4 py-4 rounded-full border-[1px] border-white border-opacity-20 absolute top-5 right-5 z-[10] flex items-center justify-center backdrop-blur-sm">
