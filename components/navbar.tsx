...
export default function Navbar()
{
    return(
        <div id='navbar' key='navbar' className="w-[max-content] p-2 lg:p-4 rounded-full border-[1px] border-white border-opacity-20 top-2 right-2 absolute lg:top-5 lg:right-5 z-[10] flex items-center justify-center backdrop-blur-sm">
            ...
            <a href="/Akhil Trivedi Resume NMN.pdf" target="_blank"><div className="flex items-center justify-center text-black bg-white p-2 lg:p-3 text-sm rounded-full hover:bg-opacity-80"><IoDocumentText className="opacity-60 text-md lg:text-xl mr-1"/> Resume</div></a>
        </div>
    )
}
