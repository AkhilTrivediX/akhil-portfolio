...
export default function InstallationGuide(){
    ...
    return(
        <div className="flex flex-col mt-12">
            ...
            />
            {installationTab == 'cli' && <div className="ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 relative rounded-md border w-full mt-4 flex codeblock overflow-hidden"><Codeblock code={`npx shadcn add https://vinima.akhiltrivedi.me/instagram.json`} language="bash"/></div>}
        </div>
    )
}